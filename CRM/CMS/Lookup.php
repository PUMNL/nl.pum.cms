...
class CRM_CMS_Lookup {
  ...
  public function representatives()
  {
    ...
    $sql = <<<SQL
     ...
     JOIN civicrm_relationship cr ON rep.id = cr.contact_id_b AND cr.relationship_type_id = %1 AND cr.is_active=1 and (cr.end_date > CURDATE() or cr.end_date is null)
